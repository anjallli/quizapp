...
Quiz is an Android application designed to provide an engaging and interactive quiz experience for users.
The application allows users to attempt quizzes through a clean and responsive interface while managing quiz-related data efficiently using Firebase integration.
